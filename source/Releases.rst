...
`Releasing a ROS 2 package <Tutorials/Releasing-a-ROS-2-package-with-bloom>`_ into the Rolling distribution follows the same procedures as all other ROS 2 distributions.
