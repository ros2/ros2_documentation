...
Nodes can :doc:`publish <About-Topics>` to named topics to deliver data to other nodes, or `subscribe <About-Topics>` to named topics to get data from other nodes.
