...
#. If the issue appears to be a valid but lacks sufficient details to replicate the envrionment (for example, the host operating system, platform, RMW implementation, ROS distro, and offending code) please request that author provide additional information.
