...
* Parameters can be passed as `command line arguments <../Guides/Node-arguments>` to C++ executables.
* Static remapping via `command line arguments <../Guides/Node-arguments>`.
