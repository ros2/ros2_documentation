...
Debian packages for ROS 2 Galactic Geochelone are currently available for Ubuntu Focal.
...
* Status Page:
  ...
  * ROS 2 Galactic (Ubuntu Focal): `amd64 <http://repo.ros2.org/status_page/ros_galactic_default.html>`__\ , `arm64 <http://repo.ros2.org/status_page/ros_galactic_ufv8.html>`__
