...
.. code-block:: bash
   ...
   python -m pip install -U catkin_pkg cryptography empy==3.3.2 importlib-metadata lark==1.1.1 lxml matplotlib netifaces numpy opencv-python PyQt5 pillow psutil pycairo pydot pyparsing==2.4.7 pyyaml rosdistro
