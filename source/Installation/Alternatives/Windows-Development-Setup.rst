...
.. note::
   ...
   To allow longer paths, see `Microsoft's documentation <https://learn.microsoft.com/en-us/windows/win32/fileio/maximum-file-path-limitation?tabs=registry>`_.
...
* Get and extract the Python 3.8.3 source from the ``tgz``:
  ...
  * `Python 3 source bundle <https://www.python.org/ftp/python/3.8.3/Python-3.8.3.tgz>`_
