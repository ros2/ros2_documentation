...
.. code-block:: bash
       ...
       rosdep install --from-paths ~/ros2_{DISTRO}/ros2-linux/share --ignore-src -y --skip-keys "cyclonedds fastcdr fastrtps python3-babeltrace python3-mypy rmw_connextdds rmw_fastrtps_dynamic_cpp rti-connext-dds-5.3.1 urdfdom_headers"
