...
class SingleTopicSensorNode : public rclcpp::Node
{
public:

  explicit SingleTopicSensorNode(const rclcpp::NodeOptions & options)
  : Node("single_topic_sensor", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(demo_keys_cpp::SingleTopicSensorNode)
