...
This tutorial is a follow up to the *Bridge communication between ROS 1 and ROS 2* demo as can be found listed with the other `demos <../Demos>`, and in the following it is assumed you have completed that tutorial already.
