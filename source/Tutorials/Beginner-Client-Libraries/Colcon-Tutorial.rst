...
For convenience, you can use the tool ``ros2 pkg create`` to create a new package based on a template. A full description of creating a package and how to use ``ros2 pkg create`` is in the upcoming tutorial :doc:`Creating a package <Creating-Your-First-ROS2-Package>`.
