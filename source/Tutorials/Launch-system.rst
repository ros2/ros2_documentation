...
The launch file in `this example <https://github.com/ros2/launch_ros/blob/dashing/launch_ros/examples/lifecycle_pub_sub_launch.py>`__
...
`The launch documentation <https://github.com/ros2/launch/blob/dashing/launch/doc/source/architecture.rst>`__ provides more details on concepts that are also used in ``launch_ros``.
