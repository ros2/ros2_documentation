...
.. tabs::
   ...
   .. group-tab:: Linux
      ...
      .. code-block:: console
            ...
            wget -O publisher_member_function.cpp https://raw.githubusercontent.com/ros2/examples/eloquent/rclcpp/minimal_publisher/member_function.cpp
   ...
   .. group-tab:: Windows
      ...
      https://raw.githubusercontent.com/ros2/examples/eloquent/rclcpp/minimal_publisher/member_function.cpp
...
.. tabs::
   ...
   .. group-tab:: Linux
      ...
      .. code-block:: console
            ...
            wget -O subscriber_member_function.cpp https://raw.githubusercontent.com/ros2/examples/eloquent/rclcpp/minimal_subscriber/member_function.cpp
   ...
   .. group-tab:: Windows
      ...
      https://raw.githubusercontent.com/ros2/examples/eloquent/rclcpp/minimal_subscriber/member_function.cpp
...
There are several ways you could write a publisher and subscriber in C++; check out the ``minimal_publisher`` and ``minimal_subscriber`` packages in the `ros2/examples <https://github.com/ros2/examples/tree/eloquent/rclcpp>`_ repo.
