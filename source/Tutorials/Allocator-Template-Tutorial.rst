...
The code for this tutorial is available `here <https://github.com/ros2/demos/blob/eloquent/demo_nodes_cpp/src/topics/allocator_tutorial.cpp>`__.
...
The `example executable <https://github.com/ros2/demos/blob/eloquent/demo_nodes_cpp/src/topics/allocator_tutorial.cpp>`__ prints the value of the variables. To run the example executable, use:
...
https://github.com/ros2/realtime_support/blob/eloquent/tlsf_cpp/example/allocator_example.cpp
