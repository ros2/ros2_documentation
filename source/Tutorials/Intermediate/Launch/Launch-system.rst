...
If you haven't already, make sure you go through the tutorial on how to :doc:`create a ROS 2 package </Tutorials/Beginner-Client-Libraries/Creating-Your-First-ROS2-Package>`.
...
launches two nodes, one of which is a node with a `managed lifecycle </Tutorials/Demos/Managed-Nodes>` (a "lifecycle node").
