...
.. code-block:: python
  ...
  def quaternion_multiply(q0, q1):
      ...
      Output
      :return: A 4 element array containing the final quaternion in (w, x, y, z) order (q03,q13,q23,q33)
      ...
      # Note: This function returns the quaternion in
      # (w, x, y, z) order rather than ROS 2's usual (x, y, z, w) convention.
