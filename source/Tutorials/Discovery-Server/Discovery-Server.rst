...
By :doc:`sourcing ROS 2 <../Configuring-ROS2-Environment>` you will get access to the CLI tool ``fastdds``.
...
.. important::
    ...
    Do not forget to :doc:`source ROS 2 <../Configuring-ROS2-Environment>` in every new terminal opened.
