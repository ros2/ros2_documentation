...
* There are several ways you could write a publisher and subscriber in Python; check out the ``minimal_publisher`` and ``minimal_subscriber`` packages in our `ros2/examples <https://github.com/ros2/examples/tree/master/rclpy/topics>`_ repo.
