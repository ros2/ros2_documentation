...
The code used in these examples can be found `here <https://github.com/ros2/examples/tree/eloquent/rclpy/topics>`__.
...
.. tabs::
   ...
   .. group-tab:: Linux
      ...
      .. code-block:: console
        ...
        wget https://raw.githubusercontent.com/ros2/examples/eloquent/rclpy/topics/minimal_publisher/examples_rclpy_minimal_publisher/publisher_member_function.py
   ...
   .. group-tab:: Windows
      ...
      https://raw.githubusercontent.com/ros2/examples/eloquent/rclpy/topics/minimal_publisher/examples_rclpy_minimal_publisher/publisher_member_function.py
...
.. tabs::
   ...
   .. group-tab:: Linux
      ...
      .. code-block:: console
        ...
        wget https://raw.githubusercontent.com/ros2/examples/eloquent/rclpy/topics/minimal_subscriber/examples_rclpy_minimal_subscriber/subscriber_member_function.py
   ...
   .. group-tab:: Windows
      ...
      https://raw.githubusercontent.com/ros2/examples/eloquent/rclpy/topics/minimal_subscriber/examples_rclpy_minimal_subscriber/subscriber_member_function.py
...
* There are several ways you could write a publisher and subscriber in Python; check out the ``minimal_publisher`` and ``minimal_subscriber`` packages in the `ros2/examples <https://github.com/ros2/examples/tree/eloquent/rclpy/topics>`_ repo.
