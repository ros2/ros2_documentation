...
def _pagefind_bundle_prefix(pagename: str) -> str:
...
def _pagefind_component_urls(pagename: str) -> Tuple[str, str]:
    """(css_href, js_href) relative to current page."""
    prefix = _pagefind_bundle_prefix(pagename)
...
def _html_page_context(
    ...
    css_href, js_href = _pagefind_component_urls(pagename)
    bundle_prefix = _pagefind_bundle_prefix(pagename)
